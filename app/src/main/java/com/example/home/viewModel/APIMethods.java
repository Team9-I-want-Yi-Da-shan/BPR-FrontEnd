...
public class APIMethods {
    ...
    public void addPersonPlan(String name, int person_id, String description, String comment){
        Call<AddPersonPlanResponse> call = planApi.addPersonalPlan(new PersonalPlan(name,person_id,description,comment));
    ...
    public void getPersonalPlanByPlanID(int id){
        Call<GetPersonalPlanByPlanIDResponse> call = planApi.getPersonalPlanByPlanID(id);
    ...
    public void removePersonalPlanByPlanID(int id){
        Call<RemovePersonalPlanByPlanID> call = planApi.removePersonalPlanByPlanID(id);
    ...
    public void getPersonPlanListByPersonID(int id){
        Call<GetPersonPlanListByPersonIDResponse> call = planApi.getPersonPlanListByPersonID(id);
